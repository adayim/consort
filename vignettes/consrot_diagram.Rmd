...
vignette: >
  %\VignetteIndexEntry{consrot_diagram}
...
4.  The node labels, for ex visit number or phase, can only horizontally align to a vertical main nodes, not an exclusion box.
